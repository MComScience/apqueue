...
$pdf->Output('videos/test.pdf', 'F');

$printer = "TX 80 Thermal"; // ใส่ชื่อPrinter
exec('SumatraPDF.exe -print-to "'.$printer.'" http://192.168.1.53/apqueue/test.pdf -exit-on-print'); // ส่งไฟล์ PDF ไปยัง Printer โดยใช้ Program SumatraPDF เป็นตัวกลาง

echo "Complete Print <a href=\"videos/test.pdf\" target=_blank>test.pdf</a> to ".$printer;
