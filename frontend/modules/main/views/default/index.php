...
<div class="row">
    <div class="col-xs-12 col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2 hide-input-call display-none" style="display: none;">
                <?= Html::a('<i class="pe-7s-volume1"></i> ' . 'Call', false, ['class' => 'btn btn-info btn-lg', 'onclick' => 'Call(this);']) ?>
            </div>
        </div>
