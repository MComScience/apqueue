                                ...
                                <div class="col-sm-12">
                                    ...
                                    echo TabularForm::widget([
                                        ...
                                        /*
                                          ...
                                          'after' =>
                                          Html::a('<i class="glyphicon glyphicon-plus"></i> Add New', ['/settings/default/create-service-route'], ['class' => 'btn btn-success', 'role' => 'modal-remote',]) . ' ' .
...
<?php echo $this->render('_script', ['url' => \yii\helpers\Url::to(['/settings/default/delete-service-route'])]); ?>
